error_messages = [{'email_conflict': 'Sign up request for could not be completed due to existance of same email'},
                  {'validation_error': "An expected error occurred during data Validation"},
                  {'Invalid_email':
                      "Email is not well formatted (Must have @ and .com) and not contain spaces or #,$,%,^,&,*,!,(,) and :"},
