...
#         '/api/v1/orders', data=mock_order[0], content_type='application/json')
...
#     result = app.test_client()
#     response = result.post(
#         '/api/v1/orders', data=mock_order[1], content_type='application/json')
#     assert(response.status_code == 400)
...
#     result = app.test_client()
#     response = result.post(
#         '/api/v1/orders', data=mock_order[2], content_type='application/json')
#     assert(response.status_code == 400)
...
#     result = app.test_client()
#     old_num_orders = bool(testorders.orders)
#     response = result.post(
#         '/api/v1/orders', data=json.dumps(mock_order[3]), content_type='application/json')
#     data = json.loads(response.data)
#     new_num_orders = bool(data)
...
#     result = app.test_client()
#     response = result.get('/api/v1/orders/100',
...
#     result = app.test_client()
#     response = result.put(
#         '/api/v1/orders/1', data=mock_answers[0], content_type='application/json')
#     assert(response.status_code == 400)
...
#     result = app.test_client()
#     response = result.put(
#         '/api/v1/orders/1', data=json.dumps(mock_answers[1]), content_type='application/json')
#     assert(response.status_code == 200)
...
#     result = app.test_client()
#     response = result.delete('/api/v1/orders/300',
#                              content_type='application/json')
#     assert(response.status_code == 404)
